    ...
    <div className="text-foreground">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              ...
              keuzes kunt maken in werk, relaties en persoonlijke groei.
            </p>
      ...
      <section className="bg-muted/40 border-y border-border py-16">
        <div className="px-6 space-y-10">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-foreground">Zie sneller wat er onder je gedrag zit</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Meer zelfinzicht, minder ruis", body: "Met een G-schema maak je duidelijk wat er precies gebeurde, wat je dacht en wat je voelde, zodat je snapt waarom je deed wat je deed." },
              { title: "Doorbreek terugkerende patronen", body: "Je ziet terugkerende patronen in situaties, gedachten en reacties, waardoor je gerichter kunt oefenen met ander gedrag." },
              { title: "Kleine stappen, echte verandering", body: "In plaats van alleen nadenken, vertaal je elk inzicht naar 1–2 concrete acties die je in je dagelijkse leven kunt testen." },
            ].map((card) => (
      ...
      <section className="px-6 py-16 space-y-10">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-foreground">In 3 stappen naar meer grip op je patronen</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { step: "Stap 1 – Kies een situatie", body: "Kies een moment dat je is bijgebleven, bijvoorbeeld een spanningsmoment op je werk of een conflict thuis." },
            { step: "Stap 2 – Beantwoord enkele vragen", body: "doel.io leidt je stap voor stap langs gebeurtenis, gedachten, gevoelens, gedrag en gevolgen." },
            { step: "Stap 3 – Maak een klein actieplan", body: "Aan het eind helpt doel.io je om 1–2 concrete acties te kiezen voor een volgende situatie." },
          ].map((s, i) => (
